...
__year__ = "2014-2015"
__description__ = "Makes an energy spectrum from a cross-correlation function \
at a specific time bin. User can indicate whether to produce spectra that are \
...
outfile -b phase_bin [-s spectrum_type]", description="Makes energy spectrum \
from a cross-correlation function at a specific time bin.", epilog="For\
...
to write the energy spectrum to.")
	...
	parser.add_argument('-b', '--bin', type=type_positive_int, dest='bin_num', \
default=0, help="The phase bin number of the CCF to select energy bins for. \
[0]")
	
	parser.add_argument('-s', '--spec', type=int, dest='spec_type', 
choices=range(0, 3), default=0, help="Indicating the type of spectrum to \
produce. 0 for mean+ccf, 1 for ccf, 2 for mean. [0]")
